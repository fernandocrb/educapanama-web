 ...
 *
 * La decisión se guarda en localStorage bajo "educapanama-cookies" con el
 * valor "aceptadas" o "rechazadas", y se puede cambiar desde /privacidad.
 *
...
(function () {
  ...
  var CLAVE = "educapanama-cookies";
  var GTM_ID = "GTM-M2QSK5L4";
  ...
  function mostrarAviso() {
    ...
    aviso.innerHTML =
      ...
      '<button type="button" class="btn btn-secundario" data-cookies="rechazadas">Rechazar</button>' +
      '<button type="button" class="btn btn-primario" data-cookies="aceptadas">Aceptar</button>' +
      "</div>";
